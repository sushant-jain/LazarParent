...
public class CustomProgressDialog2 extends AlertDialog {

    private boolean mIndeterminate = false;
    private String mMessage;

    static CustomProgressDialog2 customProgressDialog=null;

    protected CustomProgressDialog2(@NonNull Context context) {
        super(context);
    }

    protected CustomProgressDialog2(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected CustomProgressDialog2(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static void showCustomDialog(Context ctx, String msg){
       // if(customProgressDialog==null) {
        if(customProgressDialog!=null){
            ...
            customProgressDialog = new CustomProgressDialog2(ctx);
